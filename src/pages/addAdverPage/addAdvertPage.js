...
import ImagesComponent from "../../component/imageComponent";
        ...
        >
          ...
          >
            <ImagesComponent
              urls={data.urls}
              page="add"
              setUrls={(value) => setData({ ...data, urls: value })}
            />
          </div>
        </Grid>
        <Grid
          ...
          {data.subDetails.map((det, index) => (
            <Grid container style={{ marginTop: "1.5%" }}>
              <TextField
                ...
                type={det.title.includes("Tarihi") ? "date" : "text"}
              ...
              <TextField
                ...
                sx={{
                  display: det.title.includes("Araç tipi") ? "block" : "none",
                }}
                onChange={(e) => handleSubDetailChange(e)}
                select
              >
              ...
              <Select
                ...
                value={det.value}
                sx={{
                  display: det.title.includes("Kimden") ? "block" : "none",
                }}
              >
                <MenuItem value="sahibinden">Sahibinden</MenuItem>
            ...
            {data.technicalProperties.map((det, index) => (
              <Grid item xs={6} style={{ marginTop: "2%" }}>
                <TextField
                  ...
                  label={det.title}
                  type={"text"}
                  onChange={(e) => handleTechnicalPropertiesChange(e)}
                />
              </Grid>
            ))}{" "}
          </Grid>
